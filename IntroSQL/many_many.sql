...
/* The order by clause first groups the rows by title first, then within those
groups sorts the roles in a way that the instructors go first. Lastly, sorts
the students by alphabetical order. */
